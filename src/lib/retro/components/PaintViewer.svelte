		...
		<div class="toolbox">
			<div class="tool-grid">
				<button
					...
					onclick={() => (tool = 'pencil')}
					title="Lápiz (P)">✏️</button
				>
				<button
					class="tool-btn"
					class:active={tool === 'brush'}
					onclick={() => (tool = 'brush')}
					title="Pincel (B)">🖌️</button
				>
				<button
					class="tool-btn"
				...
				<button
					...
					onclick={() => (tool = 'picker')}
					title="Selector color (I)">💧</button
				>
				<button
					class="tool-btn"
					class:active={tool === 'eraser'}
					onclick={() => (tool = 'eraser')}
					title="Borrador (E)">🧹</button
				>
				<button
					class="tool-btn"
					class:active={tool === 'line'}
					onmousedown={beginPreview}
					onclick={() => (tool = 'line')}
				...
				<button
					...
					title="Elipse (O)">○</button
				>
				<button
					class="tool-btn"
					class:active={tool === 'rectFilled'}
					onmousedown={beginPreview}
					onclick={() => (tool = 'rectFilled')}
					title="Rectángulo relleno">▬</button
				>
				<button
					class="tool-btn"
					class:active={tool === 'ellipseFilled'}
					onmousedown={beginPreview}
					onclick={() => (tool = 'ellipseFilled')}
					title="Elipse rellena">●</button
				>
			</div>
...
<style>
	...
	.tool-btn {
		...
		font-size: 14px;
		font-family:
			'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji', 'MS Sans Serif', 'Tahoma', sans-serif;
		display: inline-flex;
		align-items: center;
